...
import { Divider, Header, List, Table } from 'semantic-ui-react'
...
export default function LineupTable ({ gigs, tickets, status, history }) {
	...
	return <div style={styles.lineup.container}>
		{ days(gigs).map(d =>
			<Table key={d} relaxed='very' selectable style={{border:'none'}}>
				<Table.Header >
					<Table.Row>
						<Table.HeaderCell style={styles.lineup.date}>
							{d.format('MMM D, dddd')}
						</Table.HeaderCell>
					</Table.Row>
				</Table.Header>
